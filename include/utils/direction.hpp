...
class Direction : public Vector {
 public:
  Direction(double i_x, double i_y, double i_z);
  ~Direction() = default;
...
double operator*(const Direction& d, const Direction& v);
double operator*(const Direction& d, const Vector& v);
double operator*(const Vector& v, const Direction& d);
