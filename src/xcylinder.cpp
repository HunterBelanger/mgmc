...
std::shared_ptr<XCylinder> make_xcylinder(YAML::Node surface_node) {
  ...
  if (surface_node["y0"])
    ...
    std::string mssg = "XCylinder surface must have y0 defined.";
  ...
  if (surface_node["z0"])
    ...
    std::string mssg = "XCylinder surface must have z0 defined.";
    fatal_error(mssg, __FILE__, __LINE__);
  }
  ...
  if (surface_node["r"])
    ...
    std::string mssg = "XCylinder surface must have r defined.";
    fatal_error(mssg, __FILE__, __LINE__);
  }
